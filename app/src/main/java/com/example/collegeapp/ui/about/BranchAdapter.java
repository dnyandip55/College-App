...
public class BranchAdapter extends PagerAdapter {
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
        ...
        ImageView brIcon = view.findViewById(R.id.br_icon);
        TextView brTitle = view.findViewById(R.id.br_title);
        TextView brDesc = view.findViewById(R.id.br_desc);

        brIcon.setImageResource(list.get(position).getImg());
        brTitle.setText(list.get(position).getTitle());
        brDesc.setText(list.get(position).getDesc());
